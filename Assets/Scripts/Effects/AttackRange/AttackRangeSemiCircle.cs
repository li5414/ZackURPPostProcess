...
public class AttackRangeSemiCircle : MonoBehaviour
{
    [SerializeField]
    ...
    public void UpdateRange(float radius, int angle, Material mat)
    {
        this._Radius = radius;
        this._Angle = angle;
        this._Material = mat;
    ...
    {
        this._Mesh = SemicircleMesh(this._Radius, this._Angle, Vector3.up);
