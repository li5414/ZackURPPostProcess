    ...
    public static class Record
    {
        ...
        public static class Prefabs
        {
            ...
            public class Entry
            {
                ...
                public Action<Rigidbody> Action { get; private set; }
                ...
                public Entry(GameObject prefab, GameObject instance, Action<Rigidbody> action)
                {
                    this.Prefab = prefab;
            ...
            public static PredictionTimeline Add(GameObject prefab, Action<Rigidbody> action)
            {
                var mode = CheckPhysicsMode(prefab);

                return Add(prefab, mode, action);
            }
            public static PredictionTimeline Add(GameObject prefab, PredictionPhysicsMode mode, Action<Rigidbody> action)
            {
                var timeline = new PredictionTimeline();
